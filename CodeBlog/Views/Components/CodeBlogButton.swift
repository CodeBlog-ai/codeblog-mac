//
//  CodeBlogButton.swift
//  CodeBlog
//
//  Custom button component with CodeBlog branding
//

import SwiftUI
import AppKit

struct CodeBlogButton: View {
    let title: String
    let action: () -> Void
...
struct CodeBlogButton_Previews: PreviewProvider {
    static var previews: some View {
        VStack(spacing: 20) {
            CodeBlogButton(title: "Start", action: {})
            CodeBlogButton(title: "Continue", action: {}, width: 200)
            CodeBlogButton(title: "Next", action: {}, width: 120, fontSize: 14)
            CodeBlogButton(title: "Subtle", action: {}, isSubtle: true)
        }
        .padding(40)
