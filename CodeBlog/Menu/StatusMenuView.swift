...
struct StatusMenuView: View {
    ...
    var body: some View {
        VStack(spacing: 6) {
            ...
            MenuRow(title: "Quit Completely", systemImage: "power", accent: .red, action: quitCodeBlog)
        }
        .padding(.vertical, 9)
