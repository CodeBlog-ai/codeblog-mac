...
final class LaunchAtLoginManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.codeblog.app", category: "launch_at_login")
    ...
    /// Re-sync with System Settings, e.g. if the user adds/removes CodeBlog manually.
